        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                    ...
                    $data = $db->findAll('consulta');

                    // Mostrar datos en la tabla
                    foreach ($data as $usuario) {
                        echo '<tr>';
                        echo '<td>' . $usuario['nombre'] . '</td>';
                        echo '<td>' . $usuario['control'] . '</td>';
                        echo '<td>' . $usuario['carrera'] . '</td>';
                        echo '<td>' . $usuario['correo'] . '</td>';
                        echo '<td>' . $usuario['peso'] . ' kg.</td>';
                        echo '<td>' . $usuario['altura'] . ' .</td>';
                        echo '<td>' . $usuario['sintomas'] . ' .</td>';
                        echo '<td>' . $usuario['enfermedades'] . ' .</td>';
                        echo '<td>' . $usuario['medicamento'] . ' .</td>';
                        echo '</tr>';
                    }
