...
<body background="tecno.jpg">
    <div class="contenedor">
        ...
        <label for="nombre">Nombre Completo:</label>
            ...
            <br><br><label for="pass">Contraseña:</label>
            <input type="text" id="pass" name="contrasena" placeholder="Numero de control" required>
            ...
            <br><br><label for="telefono">Contacto de Emergencia:</label>
            <input type="text" id="telefono" name="telefono" placeholder="Numero telefonico">
